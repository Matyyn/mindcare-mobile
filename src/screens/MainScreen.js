...
const Card = ({ imageSource, title, cardTitle, cardText ,navigation}) => {
  ...
  useEffect(async ()=>{
    ...
    // Filter the data
    const filteredData = response.data.data.filter(item => item.notificationTitle === 'Appointment Accepted');
...
const App = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="Learning Paths" component={LearningPathsNavigator} options={{
        headerShown: false, 
        }}/>
      <Stack.Screen name="Rescue Sessions" component={RescueStack} options={{
          headerShown: false, 
        }}/>
      <Stack.Screen name="Routine Builder" component={ReminderNavigator} options={{
          headerShown: false, 
        }}/>
        <Stack.Screen name="Physical Health" component={RoutineBuilder} options={{
          headerShown: false, 
        }}/>
