    ...
    <>
      <View style={styles.container}>
        {isTextMode ? (
          ...
          <>
            <Text style={{ fontSize: 22, marginTop: 150, fontWeight: "600" }}>
              {journalTitle}
            </Text>
            <TouchableOpacity
              onPress={togglePause}
