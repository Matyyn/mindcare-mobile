...
const Navigation = ({ navigation }) => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Select Mood" component={MoodsScreen} />
      <Stack.Screen name="Emotions" component={EmotionsScreen} />
      <Stack.Screen name="Emotions Reason" component={EmotionsReasonScreen} />
      <Stack.Screen name="Mood Reason" component={MoodReasonScreen} />
      <Stack.Screen name="Stress Screen" component={Stress} />
